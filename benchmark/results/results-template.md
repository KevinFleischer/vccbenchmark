...
```yaml
model: ""              # full, unambiguous model id. For local GGUF use the full
                       # Hugging Face path incl. lab/tuner + quant tag, e.g.
                       # "unsloth/gemma-3-27b-it-qat-GGUF:UD-Q4_K_XL"
run_date: ""           # YYYY-MM-DD
submitter: ""          # a short tag for your submission, shown on the public
...
server_command: ''     # the exact start command of your model server, e.g. the
