...
```yaml
model: "human"              # full, unambiguous model id. For local GGUF use the full
                       # Hugging Face path incl. lab/tuner + quant tag, e.g.
                       # "unsloth/gemma-3-27b-it-qat-GGUF:UD-Q4_K_XL"
run_date: "2026-06-29"           # YYYY-MM-DD
...
server_command: "none"     # the exact start command of your model server, e.g. the
...
comments: "Comparison file. Human extraction"           # optional: anything that helped (observations, tweaks)
