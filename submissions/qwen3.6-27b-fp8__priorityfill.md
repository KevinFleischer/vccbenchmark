...
```yaml
model: "Qwen/Qwen3.6-27B-FP8"              # full, unambiguous model id. For local GGUF use the full
...
server_command: 'Hosted OpenAI-compatible API at http://localhost:4000/v1 (LiteLLM -> vLLM), served model=vllm/qwen3.6-27b (Qwen/Qwen3.6-27B-FP8), temperature=0.6, top_p=0.95, no token limit'     # the exact start command of your model server, e.g. the
