...
```yaml
model: "Gemini 3.6 Flash"              # full, unambiguous model id. For local GGUF use the full
                       # Hugging Face path incl. lab/tuner + quant tag, e.g.
                       # "unsloth/gemma-3-27b-it-qat-GGUF:UD-Q4_K_XL"
run_date: "2026-07-21"           # YYYY-MM-DD
...
server_command: 'gemini.google.com'     # the exact start command of your model server, e.g. the
...
events:
  ...
  - title: "Tanner Grove Bench20"
    ...
    all_day: false
    recurring: true
  - title: "Timber Field Bench31"
    day: Friday
    start: "14:00"
    end: "14:30"
    all_day: false
    recurring: false
  - title: "Upland Trail Bench32"
    day: Friday
    start: "15:00"
    end: "15:30"
    all_day: false
