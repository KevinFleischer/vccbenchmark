...
server_command: '.llama-server.exe -hf unsloth/Qwen3.6-35B-A3B-GGUFUD-Q6_K_XL --device Vulkan0 -fa on -c 131072 -np 2 --reasoning off --reasoning-format auto -ctk q8_0 -ctv q8_0 --image-min-tokens 1024 --no-mmap --temp 0.6 --top-p 0.95 --top-k 20 --min-p 0.0 --repeat-penalty 1.0 -b 2048 -ub 1024 --metrics --port 8080 --host 127.0.0.1'     # the exact start command of your model server, e.g. the
